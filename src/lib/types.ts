export interface Player { id: string; name: string; jersey_number: number | null; positions: string[]; photo_url: string | null; bio: string | null; walkup_song: string | null; profile_id: string | null; active: boolean; }
export interface Profile { id: string; display_name: string; role: "admin" | "player"; created_at: string; }
